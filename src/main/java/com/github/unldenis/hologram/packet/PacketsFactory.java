...
public class PacketsFactory {
    ...
    static {
        ...
        } else if (VersionUtil.isBetween(VersionUtil.VersionEnum.V1_9, VersionUtil.VersionEnum.V1_16)) {
            instance = new IPackets.PacketV1_16();
        } else if (VersionUtil.isBetween(VersionUtil.VersionEnum.V1_17, VersionUtil.VersionEnum.V1_18)) {
